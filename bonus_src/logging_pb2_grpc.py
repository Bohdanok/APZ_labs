...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMessages = channel.unary_unary(
                ...
                request_serializer=logging__pb2.EmptyRequest.SerializeToString,
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=logging__pb2.EmptyRequest.FromString,
...
class LoggingService(object):
    ...
    def GetMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/logging.LoggingService/GetMessages',
            logging__pb2.EmptyRequest.SerializeToString,
